...
from transformers import AutoTokenizer, AutoConfig, Trainer, TrainingArguments, GPT2LMHeadModel, DataCollatorForLanguageModeling
...
# change data path
saved_data = "/proj/uppmax2024-2-24/magi5470/datasets" #UPPMAX, change 
cache_data = "/proj/uppmax2024-2-24/magi5470/cache" #UPPMAX, change 

# 1. Load 'train' datasets
data = load_dataset('parquet', data_dir=saved_data) 
...
config = AutoConfig.from_pretrained("gpt2", 
                                    ...
                                    n_ctx=ctx, n_positions=ctx) # n_ctx= context length
...
args = TrainingArguments(
    output_dir=f"gpt2-models-new/model-{ctx}",
    ...
    logging_dir=f'gpt2-models-new/logs-{ctx}',
...
trainer.save_model(f'gpt2-models-new/model-{ctx}/best_model')
